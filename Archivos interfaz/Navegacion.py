...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.Button1_1.place(relx=0.4, rely=0.159, height=36, width=77)
        self.Button1_1.configure(activebackground="#d9d9d9")
        self.Button1_1.configure(activeforeground="black")
        self.Button1_1.configure(background="#ffcc00")
        ...
        self.Button1_1.configure(text='''Añadir libro''')

        self.Button1_1_1 = tk.Button(self.Frame1)
        self.Button1_1_1.place(relx=0.4, rely=0.73, height=36, width=77)
        self.Button1_1_1.configure(activebackground="#d9d9d9")
        self.Button1_1_1.configure(activeforeground="black")
        self.Button1_1_1.configure(background="#ffcc00")
        ...
        self.Button1_1_1.configure(text='''Ordenar''')
        ...
        self.Button1.place(relx=0.4, rely=0.349, height=36, width=77)
        self.Button1.configure(activebackground="#d9d9d9")
        self.Button1.configure(activeforeground="black")
        self.Button1.configure(background="#ffcc00")
        self.Button1.configure(disabledforeground="#a3a3a3")
        self.Button1.configure(foreground="#000000")
        self.Button1.configure(highlightbackground="#d9d9d9")
        self.Button1.configure(highlightcolor="#000000")
        self.Button1.configure(text='''Visualizar''')

        self.btnVisualizar = tk.Button(self.Frame1)
        self.btnVisualizar.place(relx=0.4, rely=0.54, height=36, width=77)
        ...
        self.btnVisualizar.configure(text='''Consultas''')
